...
function getStyles() { return StyleSheet.create({
  ...
  greetingRow: {
    ...
    backgroundColor: COLORS.grayLight, paddingHorizontal: SPACING.md, paddingVertical: SPACING.sm + 2,
  ...
  greetingSubtitle: { fontSize: 12, color: COLORS.textSecondary, marginTop: 2, letterSpacing: 0.3 },
  ...
  searchBar: {
    ...
    borderRadius: BORDER_RADIUS.lg, paddingHorizontal: SPACING.md, paddingVertical: 14, gap: 12,
  },
  searchDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: COLORS.textSecondary },
